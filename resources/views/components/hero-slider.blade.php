                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                        <div class="max-w-3xl relative z-20 pl-4 border-l-4 border-primary/0 slide-content transition-all duration-500">
                            <div class="overflow-hidden mb-4">
                                <span class="hero-element inline-block px-3 py-1 text-xs font-bold tracking-[0.2em] text-primary border border-primary/30 rounded-sm bg-primary/5 uppercase translate-y-10 opacity-0 transition-all duration-700 delay-100">
                                    Trending Now
                                </span>
                            </div>

                            <div class="overflow-hidden mb-4">
                                <h2 class="hero-element text-5xl md:text-7xl lg:text-8xl font-display font-bold leading-none text-white drop-shadow-2xl translate-y-20 opacity-0 transition-all duration-700 delay-200">
                                    {{ $movie['title'] }}
                                </h2>
                            </div>

                            <div class="hero-element flex items-center gap-4 text-gray-300 text-sm font-mono mb-6 translate-y-10 opacity-0 transition-all duration-700 delay-300">
                            ...
                            <div class="overflow-hidden mb-8">
                                <p class="hero-element text-gray-300 text-lg md:text-xl font-light max-w-2xl leading-relaxed line-clamp-3 translate-y-10 opacity-0 transition-all duration-700 delay-400 text-shadow-sm">
                                    {{ $movie['overview'] }}
                                </p>
                            </div>

                            <div class="hero-element flex flex-wrap gap-4 translate-y-10 opacity-0 transition-all duration-700 delay-500">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function activateSlide(index) {
        ...
        activeBg.style.transition = `transform ${duration + 500}ms ease-out`;
